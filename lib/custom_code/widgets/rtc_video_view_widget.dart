...
/// Custom widget for iOS audio playback fix using hidden RTCVideoView
/// This widget creates a hidden RTCVideoRenderer that syncs with the ConversationalAIService
/// to ensure remote audio streams are played correctly on iOS devices
