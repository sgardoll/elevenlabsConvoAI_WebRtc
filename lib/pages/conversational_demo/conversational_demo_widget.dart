...
class _ConversationalDemoWidgetState extends State<ConversationalDemoWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.getCredentials = await actions.getCredentials(
        'agent_01jz7dpwv9ef19zne1ps39cm11',
        'https://4tgke4.buildship.run/eleven-labs-credentials',
      );
      _model.initElevenlabs = await actions.initializeConversationService(
        context,
        'agent_01jz7dpwv9ef19zne1ps39cm11',
      );
    });
