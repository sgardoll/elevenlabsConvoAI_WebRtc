...
class FFAppState extends ChangeNotifier {
  ...
  Future initializePersistedState() async {
    ...
    await _safeInitAsync(() async {
      _connectionType =
          await secureStorage.getString('ff_connectionType') ?? _connectionType;
    });
  }
  ...
  String _connectionType = 'webrtc';
  String get connectionType => _connectionType;
  set connectionType(String value) {
    _connectionType = value;
    secureStorage.setString('ff_connectionType', value);
  }

  void deleteConnectionType() {
    secureStorage.delete(key: 'ff_connectionType');
  }

  double _audioInputLevel = 0.0;
  double get audioInputLevel => _audioInputLevel;
  set audioInputLevel(double value) {
  ...
  double _audioOutputLevel = 0.0;
  double get audioOutputLevel => _audioOutputLevel;
  set audioOutputLevel(double value) {
  ...
  set isSpeakerEnabled(bool value) {
    _isSpeakerEnabled = value;
  }

  bool _voiceActivityDetected = false;
  bool get voiceActivityDetected => _voiceActivityDetected;
  set voiceActivityDetected(bool value) {
    _voiceActivityDetected = value;
  }

  String _webrtcConnectionState = ' new';
  String get webrtcConnectionState => _webrtcConnectionState;
  set webrtcConnectionState(String value) {
    _webrtcConnectionState = value;
  }

  bool _echoCancellationEnabled = true;
  bool get echoCancellationEnabled => _echoCancellationEnabled;
  set echoCancellationEnabled(bool value) {
